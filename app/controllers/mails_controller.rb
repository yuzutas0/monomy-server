class MailsController < ApplicationController
  ...
  class Sendgrid
    ...
    def send(email)
      ...
      RestClient.post 'https://api.sendgrid.com/api/mail.send.json', form, :content_type => :json, 'User-Agent' => 'sendgrid/0.0.6;ruby'
    end
  end
  ...
  class Email
    ...
    def get_attachment_info(file, custom_filename=nil)
      ...
      info['file'] = file
      info['custom_filename'] = custom_filename if custom_filename.present?
      info
    end
